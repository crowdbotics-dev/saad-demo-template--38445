...
## Project Structure
    ...
    ├── saad_demo_template__38445  # Django project configurations
...
1. Clone this repo and `cd saad_demo_template__38445`
...
2. Clone this repo and `cd saad_demo_template__38445`
